...
@Component({
  selector: 'app-homework14-child',
  templateUrl: './homework14-child.component.html',
  styleUrls: ['./homework14-child.component.scss']
})
export class Homework14ChildComponent implements OnInit {
